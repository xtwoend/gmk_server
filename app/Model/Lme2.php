...
class Lme2 extends Model
{
    ...
    public string $ppm_pv = 'HMI_LME_ST_MillSpeed';
    public string $ppm_sv = 'HMI_LME_SP_MillAutSpeed';
    ...
    protected array $casts = [
        ...
        'HMI_TK_ST_DispTKTemp' => 'decimal:2',
        ...
        'HMI_LME_ST_MillSpeed' => 'decimal:2',
        'HMI_LME_SP_MillAutSpeed' => 'decimal:2',
    ...
    public function format(array $data)
    {
        ...
        return [
            ...
            'chilled_water_in_run' => $data['di_pkp1.1'][3],
            'chilled_water_out_run' => $data['di_pkp1.1'][4],
            'chilled_water_in' => $data['ai_pkp1.1'][3],
            'chilled_water_out' => $data['ai_pkp1.1'][4],
        ];
    }
